...
import { formatSpeed, formatPercentage } from '@/utils/formatters'
...
<template>
  <div class="overview-stats">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <!-- 总服务器数 -->
      <Card
        class="stat-card bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/30 border-blue-200 dark:border-blue-800"
      >
        <template #content>
          <div class="flex items-center justify-between">
            <div>
              ...
              <div class="text-sm font-medium text-blue-700 dark:text-blue-300">总服务器</div>
            </div>
          ...
          <!-- 状态分布指示器 -->
          <div
            class="flex items-center gap-2 mt-3 pt-3 border-t border-blue-200 dark:border-blue-700"
          >
        ...
        <template #content>
          <div class="space-y-4">
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center justify-between text-sm">
                <span class="text-muted-color">在线服务器:</span>
                <span class="font-medium text-purple-600"
                  >{{ overview.onlineServers }} / {{ overview.totalServers }}</span
                >
              </div>
            </div>
            ...
            <div class="pt-3 border-t border-surface-200 dark:border-surface-700">
              ...
              <div class="flex h-2 bg-surface-200 dark:bg-surface-700 rounded-full overflow-hidden">
                <div
                  ...
                  :style="{
                    width: `${(overview.totalNetworkUpload / (overview.totalNetworkUpload + overview.totalNetworkDownload)) * 100}%`,
                  }"
                ></div>
                <div
                  class="bg-blue-500 transition-all duration-300"
                  :style="{
                    width: `${(overview.totalNetworkDownload / (overview.totalNetworkUpload + overview.totalNetworkDownload)) * 100}%`,
                  }"
                ></div>
              </div>
              <div class="flex items-center justify-between mt-1">
