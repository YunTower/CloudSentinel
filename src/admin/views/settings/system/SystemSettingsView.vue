...
import settingsApi from '@/admin/apis/settings/permissions'
import { useAuthStore } from '@/admin/stores/auth'
import type { PanelSettings } from '@/shared/types/settings/panel'
import type { PermissionSettings, AdminAccount } from '@/shared/types/settings/permissions'
import type { GetUpdateData } from '@/shared/types/settings/api'
...
import type { VersionType } from '@/shared/utils/version'
import {
  RiAlignLeft,
